...
test('five-screen navigation, saved reservation defaults, and historical log pagination work',async()=>{
 ...
 w.document.querySelector('[data-draft-schedule]').click();assert.equal(w.document.querySelector('#draft-slots').value,'01:30, 22:30');assert.equal(w.document.querySelector('#draft-optional').checked,true);
